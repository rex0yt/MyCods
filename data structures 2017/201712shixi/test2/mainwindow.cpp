...
void MainWindow::LianXiChaxun()
{
    ...
    connect(&thisDialog,&DialogChaxunLianxi::getRelation,this,MainWindow::toGetRelation);
    connect(&thisDialog,&DialogChaxunLianxi::getOneAllRelation,this,MainWindow::getOneAllRelation);
    thisDialog.exec();
    return ;
}
...
//int MainWindow::getRelation(int i1, int i2)
//{
//    int ans = thisMap->getWeight(thisMap->getVertexPos(i1),thisMap->getVertexPos(i2));
//    return ans;
//}

vector<Relation> MainWindow::getOneAllRelation(int no)
{
    int vertexPos = thisMap->getVertexPos(no);
    vector<Relation> ans = thisMap->getAllRelation(vertexPos);
    return ans;
}
...
void MainWindow::ShowRelation()
{
    ...
    connect(&thisDialog,&ShowAllRelation::getRelation,this,MainWindow::toGetRelation);
